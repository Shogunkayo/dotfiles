...
theme.wallpaper                                 = "~/wallpapers/gintama.jpg"
theme.font                                      = "Roboto Bold 10"
theme.taglist_font                              = "Roboto Condensed Regular 8"
theme.fg_normal                                 = "#ffe4e7"
...
theme.border_focus                              = "#de7c77"
theme.taglist_fg_focus                          = "#FFFFFF"
theme.tasklist_bg_normal                        = "#222222"
theme.tasklist_fg_focus                         = "#feb0ac"
...
local mem = lain.widget.mem({
    settings = function()
        widget:set_markup(space3 .. markup.font(theme.font, " Mem " .. mem_now.used .. " MB "))
    end
})
...
awful.key({ modkey }, "=",
function ()
    os.execute(string.format("amixer -D pulse set %s 1%%+", theme.volume.channel))
    theme.volume.update()
end)
awful.key({ modkey }, "-",
function ()
...
function ()
    os.execute(string.format("amixer -D pulse set %s toggle", theme.volume.togglechannel or theme.volume.channel))
    theme.volume.update()
end)
return theme

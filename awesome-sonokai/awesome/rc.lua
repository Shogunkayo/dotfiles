...
globalkeys = mytable.join(
 ...
 -- General
    ...
    awful.key({ modkey }, "=",
        function ()
            os.execute(string.format("amixer -D pulse set %s 1%%+", volume.channel))
            volume.update()
        end),
    awful.key({ modkey }, "-",
        function ()
    ...
    -- rofi
       awful.key({ modkey }, "q", function() awful.spawn.with_shell("sh ~/.config/rofi/launchers/type-1/launcher.sh") end,
